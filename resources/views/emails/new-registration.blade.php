                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td style="background:{{ $EC['hero'] }};padding:48px 32px 44px;text-align:center;">
                            ...
                            <p
                                style="margin:0 auto;font-size:13px;color:{{ $EC['on_dark_mid'] }};line-height:1.6;max-width:340px;">
                                {{ $entreprise->contact_name }}@if ($entreprise->contact_email)
                    ...
                    <tr>
                        <td style="background:{{ $EC['white'] }};padding:40px 32px 36px;">
                            ...
                            <h2
                                style="margin:0 0 24px;font-size:26px;font-weight:900;color:{{ $EC['ink'] }};line-height:1.15;">
                                {{ __('mail.registration_title', ['name' => $entreprise->name]) }}
                            </h2>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <p
                                            style="margin:0 0 4px;font-size:10px;color:{{ $EC['label'] }};font-weight:600;">
                                            {{ __('mail.registration_company_label') }}
                                        </p>
                                        <p
                                            style="margin:0 0 14px;font-size:16px;font-weight:800;color:{{ $EC['ink'] }};">
                                            {{ $entreprise->name }}</p>
                                        ...
                                        @if ($entreprise->employee_count)
                                            ...
                                            <p style="margin:0 0 14px;font-size:13px;color:{{ $EC['text'] }};">
                                                {{ number_format($entreprise->employee_count) }}
                                                {{ __('mail.registration_employees') }}
                                            </p>
                                        @endif
                                        ...
                                        @if ($entreprise->contact_name || $entreprise->contact_email)
                                            ...
                                            <p style="margin:0;font-size:13px;color:{{ $EC['text'] }};">
                                                ...
                                                @if ($entreprise->contact_email)
                                                    · <a href="mailto:{{ $entreprise->contact_email }}"
                                                        style="color:{{ $EC['brand'] }};text-decoration:none;">{{ $entreprise->contact_email }}</a>
                                                @endif
                                            </p>
                                        @endif
