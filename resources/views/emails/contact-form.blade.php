...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr>
    <td style="background:{{ $EC['hero'] }};padding:48px 32px 44px;text-align:center;">
      ...
      <p style="margin:0 auto;font-size:13px;color:{{ $EC['on_dark_mid'] }};line-height:1.6;max-width:320px;">
  ...
  <tr>
    <td style="background:{{ $EC['white'] }};padding:36px 32px 0;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-left:3px solid {{ $EC['brand'] }};background:{{ $EC['card_bg'] }};border-radius:0 6px 6px 0;">
        <tr>
          <td style="padding:14px 18px;">
            <p style="margin:0 0 4px;font-size:15px;font-weight:800;color:{{ $EC['ink'] }};">{{ $senderName }}</p>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#F7F5F2;border-left:3px solid #E5E0D8;border-radius:0 6px 6px 0;">
        <tr>
          <td style="padding:18px 22px;">
            <p style="margin:0;font-size:14px;color:{{ $EC['text'] }};line-height:1.75;white-space:pre-wrap;font-style:italic;">{{ $userMessage }}</p>
          </td>
        </tr>
      </table>
    </td>
