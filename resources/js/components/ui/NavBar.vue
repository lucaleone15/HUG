...
<template>
    <!-- Barre du haut -->
    <nav
        class="navbar top-0 z-50 px-6 nav-bar w-full"
        :class="[
                ...
                <a href="/" class="flex items-center">
                    <template v-if="!logoError">
                        <img
                            :src="
                                isOpaque
                                    ? '/images/hug-logo_mark.svg'
                                    : '/images/hug-logo_mark_blanc.svg'
                            "
                            alt="HUG"
                    ...
                    <span
                        ...
                        :class="isOpaque ? 'text-brand' : 'text-white'"
                        >HUG</span
                    >
                </a>
            </div>
    ...
    <nav
        class="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-base-100 border-t border-base-200"
    ...
    >
        <div class="flex items-stretch">
            ...
            >
                ...
                <span class="text-[0.6rem] tracking-[0.04em] leading-none">{{
                    t(link.key)
                }}</span>
            </a>
        </div>
