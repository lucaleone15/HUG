...
const ITEM_POSITIONS = [
    {
        ...
        faqIndex: 0,
        rotation: -3,
        pos: { left: "6%", top: "30%", width: "15%" },
    },
    {
        id: "frequence",
        faqIndex: 8,
        rotation: -1.5,
        pos: { left: "53%", top: "26%", width: "15%" },
    },
    {
        id: "quantite",
        faqIndex: 3,
        rotation: 2.5,
        pos: { left: "70%", top: "26%", width: "15%" },
    },
    {
        id: "a-qui",
        faqIndex: 7,
        rotation: 1.5,
        pos: { left: "26%", top: "38%", width: "15%" },
    },
    {
        id: "jeun",
        faqIndex: 5,
        rotation: -1.5,
        pos: { left: "58%", top: "47%", width: "15%" },
    },
    {
        id: "sens-mal",
        faqIndex: 4,
        rotation: -2.5,
        pos: { left: "5%", top: "63%", width: "15%" },
    },
    {
        id: "qui-peut",
        faqIndex: 6,
        rotation: 1,
        pos: { left: "31%", top: "63%", width: "16%" },
    },
    {
        id: "mal",
        faqIndex: 2,
        rotation: 2.5,
        pos: { left: "48%", top: "66%", width: "14%" },
    },
    {
        id: "temps",
        faqIndex: 1,
        rotation: -1,
        pos: { left: "70%", top: "63%", width: "15%" },
    },
];
...
const decorations = [
    {
        svg: "squared-sheet.svg",
        pos: { left: "42%", top: "24%", width: "11%" },
    },
    ...
    {
        svg: "coupure2presse.svg",
        pos: { left: "85%", top: "66%", width: "13%" },
    },
];
...
<template>
    <div ref="boardRef">
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="cork-title-strip">
                                <span
                                    class="cork-tape cork-tape-l"
                                    aria-hidden="true"
                                ></span>
                                <span
                                    class="cork-tape cork-tape-r"
                                    aria-hidden="true"
                                ></span>
                                <p class="cork-title-text">
                        ...
                        <template v-for="entry in mobileGrid" :key="entry.id">
                            ...
                            <div
                                ...
                                :class="[
                                    ...
                                    {
                                        'postit-pluck':
                                            clickedId === entry.item.id,
                                    },
                                ]"
                            >
                                <button
                                    class="stagger-item postit-btn w-full border-0 bg-transparent p-0 cursor-pointer block"
                                    :aria-label="
                                        t(
                                            `entreprise.faq_${entry.item.faqIndex}_q`,
                                        )
                                    "
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            ...
                                            aria-hidden="true"
                                        ></span>
                                        <p class="postit-label">
                                            {{
                                                t(
                                                    `entreprise.faq_${entry.item.faqIndex}_short`,
                                                )
                                            }}
                                        </p>
                                    </div>
        ...
        <div class="hidden md:block cork-shell">
            <div
                class="cork-board relative w-full overflow-hidden"
            ...
            >
                ...
                >
                    ...
                    >
                        <path
                            d="M 206,324 C 338,351 428,389 512,406 C 706,343 818,309 925,282 C 1052,277 1120,277 1185,282"
                        />
                        <path d="M 1185,282 C 1148,383 1094,449 1001,498" />
                        <path
                            d="M 1001,498 C 868,581 730,621 596,662 C 718,677 780,685 841,693 C 1008,679 1098,669 1185,662"
                        />
                ...
                <div
                    ...
                    :class="[
                        'absolute',
                        { 'postit-pluck': clickedId === item.id },
                    ]"
                    :style="{
                        left: item.pos.left,
                        top: item.pos.top,
                ...
                >
                    <button
                        class="stagger-item postit-btn w-full border-0 bg-transparent p-0 cursor-pointer block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-1 rounded-sm"
                    ...
                    >
                        ...
                        >
                            <p class="postit-label">
                                {{ t(`entreprise.faq_${item.faqIndex}_short`) }}
                            </p>
                        </div>
                    </button>
                </div>
    ...
    <Teleport to="body">
        <Transition name="modal">
            ...
            >
                ...
                ></div>
                <div
                    class="notebook-card relative w-full mx-4"
                    style="max-width: 420px"
                    @click.stop
                >
                    <div class="tape"></div>
                    <button
                        class="absolute top-4 right-4 w-7 h-7 flex items-center justify-center text-gray-500 hover:text-gray-800 text-2xl leading-none font-light"
                        @click="close"
                    ...
                    <div class="pt-10 pb-7 px-6">
                        <h3
                            class="font-bold text-gray-800 mb-3 leading-snug text-base"
                        >
...
.cork-tape {
    ...
    box-shadow:
        ...
        inset 0 0 8px rgba(255, 255, 180, 0.3);
    top: -6px;
}
.cork-tape-l {
    left: 11%;
...
.postit {
    --pi-bg: #fef08a;
    background:
        linear-gradient(175deg, rgba(255, 255, 255, 0.3) 0%, transparent 42%),
        var(--pi-bg);
    box-shadow:
...
.postit-label {
    ...
    text-align: center;
    color: var(--pi-fg, rgba(0, 0, 0, 0.8));
    line-height: 1.28;
