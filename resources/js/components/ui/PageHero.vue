...
defineProps({
    ...
    titleHtml: { type: String, default: null },
...
<template>
    ...
    >
        <div class="max-w-3xl mx-auto text-center">
            <slot name="above" />
            <h1
                class="font-extrabold leading-[0.93] tracking-tight mb-5"
    ...
    <section v-else class="py-16 px-6 bg-white">
        <div
            class="max-w-5xl mx-auto grid md:grid-cols-[1.1fr_0.9fr] gap-12 items-center"
        >
            <div class="page-hero-text">
                <slot name="above" />
                <h1
                    class="font-extrabold leading-[0.93] tracking-tight text-base-content mb-5"
                    style="
                ...
                <p
                    v-if="subtitle"
                    class="text-base-content/55 mb-8 leading-relaxed"
                    style="
                        font-size: clamp(1rem, 1.5vw, 1.075rem);
                        max-width: 44ch;
                    "
            ...
            <div class="page-hero-visual">
                <slot name="visual">
                    <div
                        class="aspect-[4/3] bg-base-200 rounded-xl flex items-center justify-center text-base-content/20 text-sm select-none"
                    >
                        Visuel
                    </div>
                </slot>
