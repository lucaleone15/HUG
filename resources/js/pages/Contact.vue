...
if (!props.old?.type && !props.old?.message) {
    ...
    if (urlParams.get("prefill") === "1") {
        ...
        const parsedReasons = rawReasons
...
<template>
    <div class="min-h-screen bg-base-100 flex flex-col">
        ...
        <main class="max-w-5xl mx-auto px-6 py-16 flex-1 w-full">
            ...
            >
                <div
                    class="text-brand font-bold mb-3"
            ...
            <div
                v-else
                class="grid md:grid-cols-[1fr_1.6fr] gap-16 border-t border-base-200 pt-12"
                ref="formRef"
            >
                <div
                    class="space-y-8 reveal-up"
                ...
                >
                    ...
                    <div class="space-y-1">
                        <p
                            class="text-xs uppercase tracking-[0.2em] text-base-content/35 mb-2"
                        >
                            {{ t("contact.email_label") }}
                        </p>
                        <a
                            href="mailto:info@donnez-votre-sang.ch"
                ...
                <form
                    action="/contact"
                    method="POST"
                    class="flex flex-col gap-5 reveal-up"
                    :class="{ 'reveal-up--visible': formVisible }"
                ...
                >
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <textarea
                            ...
                            :class="errors.message ? 'textarea-error' : ''"
                        ></textarea>
                        <span
                            v-if="errors.message"
