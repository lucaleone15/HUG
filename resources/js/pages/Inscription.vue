...
const handleSubmit = (e) => {
    if (!primaryTouched.value || primaryColor.value === COLOR_DEFAULT) {
        ...
        document
            .getElementById("primary-color-field")
...
<template>
    <div class="min-h-screen bg-base-100 flex flex-col">
        ...
        <section class="border-b border-base-200">
            <div
                class="max-w-5xl mx-auto px-6 py-14 grid md:grid-cols-[1fr_1.4fr] gap-12 items-center"
            >
                <div class="page-hero-text">
                    <h1
                        class="font-extrabold leading-tight text-base-content"
                        style="font-size: clamp(1.75rem, 4vw, 2.75rem)"
                    >
                        {{ t("inscription.hero_line1") }}<br />
                        <span class="text-brand">{{
                            t("inscription.hero_program_name")
                        }}</span>
                    </h1>
                </div>
                <div
                    class="bg-brand-dark text-white rounded-xl px-8 py-8 relative overflow-hidden page-hero-visual"
                >
                    <p
                        class="font-semibold mb-3 leading-tight"
        ...
        <main class="max-w-3xl mx-auto px-6 py-14 flex-1 w-full">
            ...
            <template v-if="success">
                <div class="py-12 border-b border-base-200 mb-8">
                    ...
                    <p
                        class="text-base-content/60 mb-8 leading-relaxed"
            ...
            <template v-else>
                <h2
                    class="font-bold mb-10 leading-tight"
                    style="font-size: clamp(1.35rem, 2.5vw, 1.75rem)"
                >
                ...
                >
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        >
                            <option value="" disabled>
                                {{ t("inscription.select_placeholder") }}
                            </option>
                            <option
                                v-for="type in types"
                                :key="type"
                        ...
                        <span v-if="errors.type" class="text-error text-xs">{{
                            errors.type[0]
                        }}</span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 items-start">
                        <div class="flex flex-col gap-1">
                            ...
                            >
                                <div
                                    class="h-8 w-8 rounded border border-base-300 flex items-center justify-center p-0.5 shrink-0"
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="text-sm font-medium">
                                ...
                                <span
                                    ...
                                    >{{ t("inscription.logo_url_alt") }}</span
                                >
                            </label>
                            <input
                                type="url"
                                ...
                                :placeholder="
                                    t('inscription.logo_url_placeholder')
                                "
                                :value="old?.logo_url"
                            ...
                            <span class="text-xs text-base-content/40">
                                {{
                                    logoPreview
                                        ? t("inscription.logo_url_disabled")
                                        : t("inscription.logo_hint")
                                }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            >
                                <!-- Swatch cliquable -->
                                <label
                                    class="w-10 h-10 shrink-0 relative block cursor-pointer overflow-hidden border-r border-base-300 group"
                                    :title="t('inscription.color_swatch_title')"
                                >
                                    <input
                                        type="color"
                                        :value="primaryColor"
                            ...
                            <p v-if="primaryError" class="text-error text-xs">
                                {{ t("inscription.color_error_primary") }}
                            </p>
                            <p v-else class="text-xs text-base-content/45">
                                {{ t("inscription.color_hint_click") }}
                            </p>
                            <span
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="text-sm font-medium">{{
                                t("inscription.secondary_color")
                            }}</label>
                            <div
                                class="flex items-center border border-base-300 rounded-lg overflow-hidden"
                            >
                                <label
                                    class="w-10 h-10 shrink-0 relative block cursor-pointer overflow-hidden border-r border-base-300 group"
                                    :title="t('inscription.color_swatch_title')"
                    ...
                    <BaseInput
                        ...
                        :placeholder="
                            t('inscription.contact_email_placeholder')
                        "
                    ...
                    <label class="flex items-start gap-3 cursor-pointer">
                        ...
                        <div>
                            <span class="text-sm">{{
                                t("inscription.is_public")
                            }}</span>
                            <p class="text-xs text-base-content/40 mt-1">
                                {{ t("inscription.is_public_hint") }}
                            </p>
                        </div>
                    </label>
                    ...
                    >
                        ...
                        <div>
                            <span class="text-sm">{{
                                t("inscription.wants_trophy")
                            }}</span>
                            <p class="text-xs text-base-content/40 mt-1">
                                {{ t("inscription.wants_trophy_hint") }}
                            </p>
                        </div>
                    </label>
                    ...
                    <!-- Note -->
                    <p
                        class="text-xs text-base-content/45 leading-relaxed border-l-2 border-base-300 pl-3"
                        style="max-width: 52ch"
                    >
